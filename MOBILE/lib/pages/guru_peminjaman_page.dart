...
class GuruPeminjamanPage extends StatefulWidget {
  final Map<String, dynamic> user;

  const GuruPeminjamanPage({super.key, required this.user});

  @override
  State<GuruPeminjamanPage> createState() => _GuruPeminjamanPageState();
}

class _GuruPeminjamanPageState extends State<GuruPeminjamanPage>
  ...
  void _showBorrowingDetail(Map<String, dynamic> item) {
    final isCollective =
        item['is_collective'] == true ||
        item['is_collective'] == 1 ||
        item['is_collective'] == "1";
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Jumlah Total : ${item['quantity'] ?? item['details'].length} Buku",
                            style: TextStyle(
                              color: Colors.grey.shade700,
                              fontSize: 13,
                            ),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      color: (isCollective || exemplar != null)
                                          ? accentBlue
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                "•  ${isCollective ? item['quantity'] : item['details'].length} Buku",
                                style: TextStyle(
                                  color: Colors.grey.shade600,
                                  fontSize: 13,
                                  fontWeight: FontWeight.w600,
                              ...
                              if (isCollective) ...[
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "Kolektif - Kelas: ${item['class_name']}",
                                        style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 12,
                                          color: primaryDark,
