...
@endphp
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <a class="nav-link {{ request()->is('kepala/dashboard') ? 'active' : '' }}" href="/kepala/dashboard">
                <i class="bi bi-grid-1x2-fill"></i> Dashboard
            </a>

            <div class="menu-title">Monitoring</div>
            <a class="nav-link {{ request()->is('kepala/buku*') ? 'active' : '' }}" href="{{ route('kepala.buku') }}">
                <i class="bi bi-book-fill"></i> Data Buku
            </a>
            <a class="nav-link {{ request()->is('kepala/anggota*') ? 'active' : '' }}" href="{{ route('kepala.anggota') }}">
                <i class="bi bi-people-fill"></i> Data Anggota
            </a>
            <a class="nav-link {{ request()->is('kepala/transaksi*') ? 'active' : '' }}" href="{{ route('kepala.transaksi') }}">
                <i class="bi bi-arrow-left-right"></i> Transaksi
            </a>

            <div class="menu-title">Analitik</div>
            <a class="nav-link {{ request()->is('kepala/laporan*') ? 'active' : '' }}" href="{{ route('kepala.laporan') }}">
                <i class="bi bi-bar-chart-fill"></i> Laporan & Statistik
            </a>

            <div class="menu-title">Manajemen</div>
            <a class="nav-link {{ request()->is('kepala/pustakawan*') ? 'active' : '' }}" href="{{ route('kepala.pustakawan') }}">
                <i class="bi bi-person-badge-fill"></i> Kelola Pustakawan
            </a>
            <a class="nav-link {{ request()->is('kepala/approval*') ? 'active' : '' }}" href="{{ route('kepala.approval') }}">
                <i class="bi bi-check-circle-fill"></i> Approval Buku
            </a>

            <div class="menu-title">Akun</div>
            <a href="{{ route('kepala.profile') }}" class="nav-link {{ request()->is('kepala/profile*') ? 'active' : '' }}">
    ...
    <div class="main-content">
        ...
        <div class="topbar d-flex justify-content-between align-items-center">
            <div class="d-none d-md-block">
                ...
                <p>Dashboard kepala pustakawan SMAN 3 Padang</p>
            </div>
    ...
    <div
        ...
        <div class="notification-header">
            ...
            @if($notificationCount > 0)
                ...
                <a
                    href="{{ route('kepala.notification.clear') }}"
        ...
        transform:translateY(0);
                ...
                <div class="profile-widget d-flex align-items-center gap-3">
                    ...
                    <div class="text-start d-none d-sm-block">
                        <div class="fw-bold lh-1 mb-1" style="font-size: 0.9rem; color: var(--text-main);">{{ Auth::user()->name ?? 'Kepala Pustakawan' }}</div>
                        <small class="text-muted" style="font-size: 0.75rem;">{{ Auth::user()->role ?? 'Kepala' }}</small>
                    </div>
                </div>
            </div>
        </div>
